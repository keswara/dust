...
MySQL Backup
Database: sb
Backup Time: 2018-09-15 01:30:21
*/
...
DELETE FROM `sb`.`tree`;
INSERT INTO `sb`.`tree` (`id`,`notree`,`datetree`,`groupt`,`actor`,`type`,`lot`,`comment`,`orderno`) VALUES (1, 'SB61091400001', '14-09-2561 23:55:28pm', 'แปลงA', 'admin', 'ฝรั่งกิมจู จำพวก ไม้ผล', 'ตอน 1 แถว1  หมวด ก', 'ฝั่งกระท่อมตาเปี๊ยก', '1'),(2, 'SB61091500002', '15-09-2561 00:09:52am', 'แปลงA', 'admin', 'ฝรั่งกิมจู จำพวก ไม้ผล', 'ตอน 1 แถว2  หมวด ก', '', '2'),(3, 'SB61091500003', '15-09-2561 00:20:14am', 'แปลงB', 'admin', 'ฝรั่งกิมจู จำพวก ไม้ผล', 'ตอน 1 แถว1  หมวด ก', '', '85'),(4, 'SB61091500004', '15-09-2561 01:24:57am', 'แปลงA', 'keswara', 'มะพร้าวน้ำหอม จำพวก ไม้ล้มลุก', 'ตอน 1 แถว2  หมวด ข', '', '12'),(5, 'SB61091500005', '15-09-2561 01:26:31am', 'แปลงE', 'keswara', 'เสาวรส จำพวก ไม้ล้มลุก', 'ตอน 1 แถว1  หมวด ก', '', '1');
UNLOCK TABLES;
COMMIT;
BEGIN;
LOCK TABLES `sb`.`type` WRITE;
DELETE FROM `sb`.`type`;
INSERT INTO `sb`.`type` (`id`,`name`,`detail`,`insite`) VALUES (2, 'ฝรั่งกิมจู', 'ไม้ผล', '2017-01-01'),(3, 'มะพร้าวน้ำหอม', 'ไม้ล้มลุก', '2018-01-31'),(4, 'ลำใย', 'ไม้ผล', '2018-08-16'),(5, 'เสาวรส', 'ไม้ล้มลุก', '2018-02-02');
UNLOCK TABLES;
COMMIT;
